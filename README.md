...
<p align="center">
  ...
  <a href="#databases-schema"><img src="https://img.shields.io/badge/firefox-59%20--%20v41-ea7015.svg?style=flat-square" alt="Database Schema"></a>
...
| File name                                                                                                                                                             | OS      | Arch    |
| --------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------- | ------- |
| **[firefox-history-merger-1.59.0-darwin-amd64](https://github.com/crazy-max/firefox-history-merger/releases/download/1.59.0/firefox-history-merger-1.59.0-darwin-amd64)**           | macOS   | x86-64  |
| [firefox-history-merger-1.59.0-darwin-386](https://github.com/crazy-max/firefox-history-merger/releases/download/1.59.0/firefox-history-merger-1.59.0-darwin-386)                   | macOS   | x86     |
| **[firefox-history-merger-1.59.0-linux-amd64](https://github.com/crazy-max/firefox-history-merger/releases/download/1.59.0/firefox-history-merger-1.59.0-linux-amd64)**             | Linux   | x86-64  |
| [firefox-history-merger-1.59.0-linux-386](https://github.com/crazy-max/firefox-history-merger/releases/download/1.59.0/firefox-history-merger-1.59.0-linux-386)                     | Linux   | x86     |
| **[firefox-history-merger-1.59.0-windows-amd64.exe](https://github.com/crazy-max/firefox-history-merger/releases/download/1.59.0/firefox-history-merger-1.59.0-windows-amd64.exe)** | Windows | x86-64  |
| [firefox-history-merger-1.59.0-windows-386.exe](https://github.com/crazy-max/firefox-history-merger/releases/download/1.59.0/firefox-history-merger-1.59.0-windows-386.exe)         | Windows | x86     |
